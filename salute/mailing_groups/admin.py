...
class MailGroupAdmin(admin.ModelAdmin):
    ...
    def create_workspace_group_view(self, request: HttpRequest, mailing_group_id: uuid.UUID) -> HttpResponseRedirect:
        # Check permission
        ...
        # Handle POST request (confirmation)
            ...
            try:
                ...
                try:
                    ...
                    messages.success(
                        request,
                        f"Google Workspace group '{workspace_group}' successfully created and connected to {mailing_group.name}.",
                    )
